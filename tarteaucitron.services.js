...
tarteaucitron.services.twittertimeline = {
    ...
    "js": function () {
        ...
        var elements = document.getElementsByClassName('tac_activate_' + this.key);
    ...
    "fallback": function () {
        ...
        tarteaucitron.fallback(['tacTwitterTimelines'], function (elem) {
            return tarteaucitron.engage(id, elem.innerHTML);
        });
